...
class TranferMoneyVC: UIViewController {
...
extension TranferMoneyVC: UITextFieldDelegate {
...
extension TranferMoneyVC: UISearchBarDelegate {
...
extension TranferMoneyVC: UITableViewDelegate, UITableViewDataSource {
