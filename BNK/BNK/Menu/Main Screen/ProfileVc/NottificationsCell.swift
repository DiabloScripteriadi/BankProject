...
class NottificationsCell: UITableViewCell {
    ...
    private func setupUi() {
        ...
        NSLayoutConstraint.activate([
            notficationsButton.topAnchor.constraint(equalTo: contentView.topAnchor, constant: 20),
            notficationsButton.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 20),])
    }
