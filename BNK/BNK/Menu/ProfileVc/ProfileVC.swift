...
class ProfileVC: UIViewController {
    ...
    private lazy var tableView: UITableView = {
        ...
        tb.register(ChangeLanguageCell.self, forCellReuseIdentifier: "ChangeLanguageCell")
        tb.register(LogOutCell.self, forCellReuseIdentifier: "LogOutCell")
        tb.register(NottificationsCell.self, forCellReuseIdentifier: "NottificationsCell")
        tb.register(SecurityPoliticsCell.self, forCellReuseIdentifier: "SecurityPoliticsCell")
        return tb
    }()
...
extension ProfileVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0 :
            let cell = tableView.dequeueReusableCell(withIdentifier: "AuthorizationCell", for: indexPath) as! AuthorizationCell
            
            return cell
        case 1 :
            let cell = tableView.dequeueReusableCell(withIdentifier: "ChangeLanguageCell", for: indexPath) as! ChangeLanguageCell
...
//            }
        ...
        case 2 :
            ...
            let cell = tableView.dequeueReusableCell(withIdentifier: "SecurityPoliticsCell", for: indexPath) as! SecurityPoliticsCell
            return cell
        case 3 :
            let cell = tableView.dequeueReusableCell(withIdentifier: "NottificationsCell", for: indexPath) as! NottificationsCell
            return cell
        default: 
...
//}
#warning("pagebia gasaketebeli da funqciebi misamatebeli meti")
